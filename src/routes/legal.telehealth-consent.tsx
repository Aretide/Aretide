...
const SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    content: (
      <>
        <LegalP>
          Telehealth involves delivering healthcare when you and your Provider
          are not in the same physical location. Care may include secure
          messaging, asynchronous questionnaires, photo or document uploads,
          video or phone visits when clinically appropriate, and electronic
          transmission of medical records and prescriptions.
        </LegalP>
        <LegalP>
          In-person care may be available from other healthcare professionals.
          You may discuss alternatives with your Provider at any time and may
          choose a different method of care.
        </LegalP>
      </>
    ),
  },
  {
    ...
    content: (
      <LegalP>
        Telehealth may make it easier to access weight-management care,
        communicate with a Provider on your schedule, receive follow-up without
        traveling to an office, and coordinate prescriptions, labs, and refill
        support through a single platform.
      </LegalP>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <LegalList
          items={[
            <>
              The quality, accuracy, or effectiveness of care may be limited
              compared with an in-person visit.
            </>,
            <>
              Technology failures, outages, or errors may delay diagnosis,
              treatment, or communication.
            </>,
            <>
              Your Provider may be unable to perform certain physical exams,
              vital-sign checks, or in-office tests remotely.
            </>,
            <>
              Your condition may not be suitable for telehealth, and you may
              need in-person, specialist, or emergency care.
            </>,
            <>
              Delays may occur if your Provider is unavailable or if information
              you provide is incomplete or inaccurate.
            </>,
            <>
              Electronic systems can fail or be breached despite safeguards,
              which could affect privacy.
            </>,
            <>
              Email, SMS, or other channels you use outside the Service may not
              be secure.
            </>,
            <>
              Limited access to your full medical history may increase the risk
              of drug interactions or missed diagnoses.
            </>,
            <>
              State rules may limit certain prescriptions or treatment options
              through telehealth.
            </>,
          ]}
        />
    ...
    content: (
      <>
        ...
        <LegalP>
          ...
          Service. If you need urgent in-person evaluation, seek care at an
          emergency facility or urgent-care center equipped to treat your
          condition.
        </LegalP>
        <LegalP>
  ...
  },
  {
    ...
    content: (
      <>
        <LegalP>
          Not every condition can be diagnosed or treated through telehealth.
          Your Provider will assess whether telehealth is medically appropriate
          for you. If your Provider determines that your condition requires
          in-person evaluation, specialist referral, or a different level of
          care, you agree to follow that guidance.
        </LegalP>
        <LegalP>
          Completing intake or receiving a telehealth visit does not guarantee
          that a prescription will be issued. All treatment decisions are made
          independently by your Provider based on clinical judgment.
        </LegalP>
      </>
    ),
  },
    ...
    content: (
      <>
        <LegalP>
          ...
          protect information transmitted through the Service, including
          encryption in transit, access controls, and audit logging for
          sensitive actions.
        </LegalP>
        <LegalP>
          Your information may be used and disclosed as described in our Privacy
          Policy and as permitted by law for treatment, payment, healthcare
          operations, and related administrative purposes. We cannot guarantee
          the security of systems outside our control, such as your personal
          email or mobile carrier.
        </LegalP>
      </>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <>
        <LegalP>
          Some care plans may require laboratory testing or other diagnostics.
          If ordered, you may need to visit a designated lab, use an at-home
          collection kit, or provide results from another licensed facility. You
          are responsible for following collection instructions and completing
          tests within any stated timeframe.
        </LegalP>
        <LegalP>
          Test availability, accuracy, and turnaround times depend on the
          laboratory and your circumstances. Your Provider will explain how
          results affect your care.
        </LegalP>
      </>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <>
        <LegalP>
          By using the Service for clinical care, you acknowledge that:
        </LegalP>
        <LegalList
          items={[
            <>
              You have read and understand the benefits, risks, and limitations
              of telehealth described in this Consent.
            </>,
            <>
            ...
            <>
              ...
              and following treatment instructions.
            </>,
            <>
              Some visits may be conducted by nurse practitioners or physician
              assistants where permitted by law.
            </>,
            <>
              No specific outcome, prescription, or test result is guaranteed.
            </>,
            <>
              Treatment sessions through the Service are not routinely recorded
              unless you are separately notified and agree.
            </>,
            <>
    ...
    content: (
      <>
        <LegalP>
          ...
          who offer care exclusively through telehealth.
        </LegalP>
        <LegalP>
...
function TelehealthConsentPage() {
  useEffect(() => {
    trackPageViewed("telehealth_consent");
  }, []);
  return (
    <MarketingLayout>
      <Section>
