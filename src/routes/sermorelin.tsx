...
const DESCRIPTION = `Compounded sermorelin injections, reviewed by licensed providers. Nationwide telehealth care at ${formatSimpleStartingAt(SERMORELIN_PRICING)}. Prescribing is never guaranteed.`;
...
const FAQ_ITEMS: TreatmentFaqItem[] = [
  ...
  },
  {
    ...
    a: `${simplePricingSentence("Compounded sermorelin through Beema", SERMORELIN_PRICING)} That covers your provider consultation and ongoing doctor care, prescription medication, and expedited shipping. Questions about your plan? ${patientQuestionsGuidance()}`,
  },
  {
          ...
          <div className="mt-8 grid items-center gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:gap-14">
            <div>
              ...
              <p className="mt-6 max-w-md text-2xl font-bold text-foreground">
                {formatSimpleStartingAt(SERMORELIN_PRICING)}
              </p>
            ...
            >
              <TreatmentHeroArt icon={Syringe} label="Compounded Sermorelin" />
              <TreatmentIncludedDropdown
