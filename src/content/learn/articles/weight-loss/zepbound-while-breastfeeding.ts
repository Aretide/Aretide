...
export const article: LearnArticle = {
  ...
  slug: "zepbound-while-breastfeeding",
  title: "Zepbound and Breastfeeding: Limited Milk Data",
  h1: "Zepbound while breastfeeding: what the lactation study did and did not show",
  description:
  ...
  keywords: [
    ...
    "Zepbound lactation",
    "tirzepatide breast milk",
    "Zepbound nursing",
    "Mounjaro breastfeeding",
    "tirzepatide milk study",
  ],
  cluster: "life-stage",
  relatedSlugs: [
  ...
  sources: [
    {
      label:
        "Zepbound (tirzepatide) prescribing information. Eli Lilly. Section 8.2 Lactation, including the single-dose milk study, and section 8.3 contraception.",
      href: "https://pi.lilly.com/us/zepbound-uspi.pdf",
    },
    {
      label:
        "Zepbound Medication Guide. Eli Lilly. Patient information on pregnancy and feeding.",
      href: "https://pi.lilly.com/us/zepbound-us-mg.pdf",
    },
    {
      label:
        "Mounjaro (tirzepatide) prescribing information. Eli Lilly. Lactation section for the diabetes brand of tirzepatide.",
      href: "https://pi.lilly.com/us/mounjaro-uspi.pdf",
    },
    {
      label:
        "Centers for Disease Control and Prevention. Breastfeeding recommendations and guidance.",
      href: "https://www.cdc.gov/breastfeeding/php/guidelines-recommendations/index.html",
    },
    {
      label:
        "American College of Obstetricians and Gynecologists. Optimizing Postpartum Care. Committee Opinion No. 736.",
      href: "https://www.acog.org/clinical/clinical-guidance/committee-opinion/articles/2018/05/optimizing-postpartum-care",
    },
  ],
  faqs: [
    {
      question: "Is Zepbound safe while breastfeeding?",
      answer:
    ...
    {
      question: "Does the milk study mean I can stay on 15 mg?",
      answer:
    ...
    {
      question: "Is Mounjaro the same for nursing?",
      answer:
    ...
    {
      question: "Should I pump and dump after my weekly shot?",
      answer:
    ...
    {
      question: "If milk levels were low, why is this still a big deal?",
      answer:
  ...
  sections: [
    ...
    {
      id: "the-study",
      heading: "What the lactation study measured",
      body: [
    ...
    {
      id: "benefit-risk-sentence",
      heading: "The sentence FDA still wants clinicians to use",
      body: [
    ...
    {
      id: "practical-risks",
      heading: "Maternal side effects that can still affect feeding",
      body: [
    ...
    {
      id: "supply-and-gi",
      heading: "If supply drops after a dose increase",
      body: [
    ...
    {
      id: "visit-checklist",
      heading: "Questions for the prescriber and the baby’s clinician",
      body: [
