...
export const article: LearnArticle = {
  ...
  slug: "foods-to-avoid-on-tirzepatide",
  title: "Foods That Often Worsen Tirzepatide Nausea (Not a Ban List)",
  h1: "Tirzepatide and food triggers: what people usually mean by “foods to avoid”",
  description:
  ...
  keywords: [
    ...
    "Mounjaro nausea food",
    "what not to eat on tirzepatide",
    "tirzepatide greasy food",
  ],
  cluster: "lifestyle",
  relatedSlugs: [
    "glp-1-diet",
  ...
  sources: [
    {
      label:
        "Zepbound (tirzepatide) prescribing information. Eli Lilly. Gastrointestinal adverse reactions, delayed gastric emptying, and oral medication absorption.",
      href: "https://pi.lilly.com/us/zepbound-uspi.pdf",
    },
    {
      label:
        "Mounjaro (tirzepatide) prescribing information. Eli Lilly. Gastrointestinal adverse reactions and delayed gastric emptying.",
    ...
    },
    {
      ...
      href: "https://www.cdc.gov/healthy-weight-growth/healthy-eating/index.html",
    },
    {
      label:
        "National Institute of Diabetes and Digestive and Kidney Diseases. Pancreatitis. Alcohol as a risk factor for pancreatitis.",
      href: "https://www.niddk.nih.gov/health-information/digestive-diseases/pancreatitis",
    },
  ],
  faqs: [
    {
      question: "Is there an official list of foods forbidden on tirzepatide?",
      answer:
    ...
    {
      question: "Why do fried foods bother people on Zepbound or Mounjaro?",
      answer:
    ...
    {
      question: "Should I avoid all carbohydrates on tirzepatide?",
      answer:
    ...
    {
      question: "Is alcohol a food to avoid on tirzepatide?",
      answer:
    ...
    {
      question: "Do I need to stop oral medicines because of food timing?",
      answer:
    ...
    {
      question: "When is nausea a reason to get medical care?",
      answer:
    ...
    {
      question: "Does a compounded tirzepatide diet differ?",
      answer:
  ...
  sections: [
    ...
    {
      id: "common-triggers",
      heading: "Meals that commonly sit poorly",
      body: [
    ...
    {
      id: "gentler-swaps",
      heading: "Gentler patterns that still count as a reduced-calorie diet",
      body: [
    ...
    {
      id: "not-food-but-related",
      heading: "Issues that look like food but are not food",
      body: [
        "Severe abdominal pain with or without vomiting can be pancreatitis or gallbladder disease, both discussed in tirzepatide labeling. Those are medical evaluations, not a cue to try a new smoothie. Right-upper-quadrant pain, fever, or yellowing of the skin or eyes needs prompt care.",
        "Oral contraceptive effectiveness can drop when starting or escalating tirzepatide. That is an absorption issue, not a salad issue. Use the backup method your clinician recommends. Thyroid hormone and other narrow-index oral drugs may need monitoring if delayed emptying changes absorption; that is a prescriber task.",
      ],
    },
    {
      id: "injection-day-meals",
      heading: "Injection-day meals without folklore",
      body: [
    ...
    {
      id: "diabetes-and-kidney",
      heading: "Diabetes, kidneys, and “eating less”",
      body: [
