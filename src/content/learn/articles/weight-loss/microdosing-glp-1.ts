...
export const article: LearnArticle = {
  ...
  slug: "microdosing-glp-1",
  title: "GLP-1 Microdosing: Meaning, Evidence Limits, and Risks",
  h1: "GLP-1 microdosing: what people mean, and what evidence does not show",
  description:
  ...
  keywords: [
    ...
    "glp-1 low dose",
    "splitting wegovy pen",
    "glp-1 starter dose long term",
  ],
  cluster: "dosing",
  relatedSlugs: [
    "glp-1-dosing",
  ...
  faqs: [
    ...
    {
      question: "Is microdosing safer than a full maintenance dose?",
      answer:
    ...
    {
      question: "Is delaying a titration step the same as microdosing?",
      answer:
    ...
    {
      question: "Can I split a Wegovy or Zepbound pen?",
      answer:
  ...
  sections: [
    {
      id: "definition",
      heading: "What people mean by microdosing a GLP-1",
      body: [
    ...
    {
      id: "what-labels-say",
      heading: "What labels actually say about small doses",
      body: [
    ...
    {
      id: "safety",
      heading: "Safety issues that are easy to miss",
      body: [
