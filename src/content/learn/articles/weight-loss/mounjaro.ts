...
export const article: LearnArticle = {
  ...
  slug: "mounjaro",
  title: "Mounjaro Explained: Diabetes Indication and Dosing",
  h1: "What is Mounjaro?",
  description:
  ...
  sources: [
    ...
    {
      label:
        "Mounjaro (tirzepatide) injection, NDA 215866. Drugs@FDA approval and labeling history.",
      href: "https://www.accessdata.fda.gov/scripts/cder/daf/index.cfm?event=overview.process&ApplNo=215866",
    },
  ],
  faqs: [
    {
    ...
    {
      question: "How do you take Mounjaro?",
      answer:
    ...
    {
      question: "What happens if I stop Mounjaro?",
      answer:
  ...
  sections: [
    ...
    {
      id: "how-it-works",
      heading: "How tirzepatide helps type 2 diabetes",
      body: [
    ...
    {
      id: "dosing",
      heading: "Labeled Mounjaro dosing",
      body: [
    ...
    {
      id: "who-is-not-a-candidate",
      heading: "Who was studied and who should not use it",
      body: [
    ...
    {
      id: "safety",
      heading: "Safety profile in brief",
      body: [
