...
export const article: LearnArticle = {
  ...
  slug: "rebound-weight-gain-after-glp-1",
  title: "Rebound Weight Gain After GLP-1: What Trials Show",
  h1: "Rebound weight gain after GLP-1 treatment",
  description:
  ...
  keywords: [
    ...
    "weight regain after wegovy",
    "weight regain after zepbound",
    "glp-1 rebound",
    "semaglutide weight regain",
    "tirzepatide weight regain",
  ...
  sources: [
    {
      ...
      href: "https://dom-pubs.onlinelibrary.wiley.com/doi/10.1111/dom.14725",
    },
    {
      label:
        "Rubino D, et al. Continued weekly semaglutide vs placebo (STEP 4). JAMA. 2021.",
  ...
  faqs: [
    {
      question: "Is rebound weight gain after a GLP-1 inevitable?",
      answer:
    ...
    {
      question: "Is rebound faster than the original loss?",
      answer:
    ...
    {
      question: "Does staying on a maintenance dose prevent rebound?",
      answer:
    ...
    {
      question: "Can diet and exercise stop rebound completely?",
      answer:
    ...
    {
      question: "Is rebound a reason never to start a GLP-1?",
      answer:
  ...
  sections: [
    ...
    {
      id: "step-evidence",
      heading: "Semaglutide: STEP 1 extension and STEP 4",
      body: [
    ...
    {
      id: "surmount-4-evidence",
      heading: "Tirzepatide: SURMOUNT-4",
      body: [
    ...
    {
      id: "not-your-fault",
      heading: "This pattern is biologic, not a character test",
      body: [
    ...
    {
      id: "options-after-regain",
      heading: "Options people discuss after regain",
      body: [
