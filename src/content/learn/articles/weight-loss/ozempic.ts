...
export const article: LearnArticle = {
  ...
  slug: "ozempic",
  title: "What Is Ozempic? Diabetes Indication, Dosing, Risks",
  h1: "What is Ozempic?",
  description:
    "Ozempic is an FDA-approved weekly semaglutide injection for type 2 diabetes, heart, and kidney risk - not a weight-loss indication. Prescription required.",
  keywords: [
    "ozempic",
    "what is ozempic",
    "ozempic semaglutide",
  ...
  sources: [
    {
      label: "Ozempic (semaglutide) U.S. Prescribing Information, Novo Nordisk",
      href: "https://www.novo-pi.com/ozempic.pdf",
    },
    {
      label: "DailyMed: Ozempic (semaglutide) injection",
      href: "https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=adec4fd2-6858-4c99-91d4-531f5f2a2d79",
    },
    {
      label:
        "Marso SP, et al. Semaglutide and cardiovascular outcomes in type 2 diabetes (SUSTAIN-6). N Engl J Med. 2016.",
  ...
  faqs: [
    {
      ...
      answer:
        "No. The FDA-approved indications for Ozempic are type 2 diabetes glycemic control, reduction of major adverse cardiovascular events in adults with type 2 diabetes and established cardiovascular disease, and reduction of kidney-disease progression and cardiovascular death in adults with type 2 diabetes and chronic kidney disease. Weight change can occur during treatment, but Ozempic is not labeled as a chronic weight-management medicine. A licensed clinician should decide whether any prescription is appropriate.",
    },
    {
      question: "How is Ozempic taken?",
      answer:
        "Ozempic is a once-weekly subcutaneous injection given in the abdomen, thigh, or upper arm, at any time of day, with or without meals. Treatment usually starts at 0.25 mg weekly for four weeks, then increases as directed on the label. It is a prescription medicine. Pens should never be shared, even if the needle is changed.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "In clinical trials, the most common adverse reactions reported in at least 5% of people treated with Ozempic were nausea, vomiting, diarrhea, abdominal pain, and constipation. Gastrointestinal effects often appear during dose increases. Serious risks described in the prescribing information include pancreatitis, gallbladder disease, acute kidney injury related to volume depletion, diabetic retinopathy complications, and severe gastrointestinal reactions. Seek urgent care for severe, persistent abdominal pain or signs of an allergic reaction.",
    },
    {
      question: "Who should not take Ozempic?",
      answer:
        "Ozempic is contraindicated in people with a personal or family history of medullary thyroid carcinoma (MTC) or with Multiple Endocrine Neoplasia syndrome type 2 (MEN 2), and in people with a serious hypersensitivity to semaglutide or any excipient. It is not for type 1 diabetes or diabetic ketoacidosis. A clinician also reviews other warnings, including a history of pancreatitis, severe gastroparesis, and planned surgery or procedures that use anesthesia.",
    },
    {
      question: "Can I start Ozempic without a prescription?",
      answer:
        "No. Ozempic is a prescription-only medicine. U.S. law requires a licensed clinician to evaluate you before it is prescribed. There is no legitimate path to obtain it from a shopping cart without that review.",
    },
  ],
  sections: [
    {
      id: "what-ozempic-is",
      heading: "What Ozempic is - and what it is approved for",
      body: [
    ...
    {
      id: "how-ozempic-works",
      heading: "How weekly semaglutide acts in type 2 diabetes",
      body: [
    ...
    {
      id: "how-ozempic-is-taken",
      heading: "How Ozempic is taken and how doses are increased",
      body: [
    ...
    {
      id: "who-was-studied",
      heading: "Who was studied - and who is not a candidate on the label",
      body: [
    ...
    {
      id: "labeled-risks",
      heading: "Boxed warning, common effects, and when to get care",
      body: [
