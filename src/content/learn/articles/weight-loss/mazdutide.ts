...
export const article: LearnArticle = {
  ...
  slug: "mazdutide",
  title: "Mazdutide: China-Approved, Not FDA-Cleared",
  h1: "Mazdutide is approved in China - not by the FDA",
  description:
  ...
  sources: [
    {
      label:
        "Keam SJ. Mazdutide: First Approval. Drugs. 2025. Summarizes NMPA approvals for weight management and type 2 diabetes in China.",
      href: "https://pubmed.ncbi.nlm.nih.gov/41028652/",
    },
    {
      label:
        "National Medical Products Administration (China). Mazdutide injection approval notice (Chinese), June 2025.",
      href: "https://www.nmpa.gov.cn/zhuanti/cxylqx/cxypxx/20250627145044169.html",
    },
    {
      label:
        "U.S. Food and Drug Administration. Foreign approvals do not authorize marketing or compounding of a new drug in the United States.",
      href: "https://www.fda.gov/drugs/development-approval-process-drugs",
    },
    {
      label:
  ...
  faqs: [
    ...
    {
      question: "What should a U.S. reader do instead?",
      answer:
  ...
  sections: [
    {
      id: "what-it-is",
      heading: "A dual GLP-1/glucagon agonist with a China label",
      body: [
    ...
    {
      id: "mechanism",
      heading: "How glucagon plus GLP-1 differs from GIP plus GLP-1",
      body: [
    ...
    {
      id: "evidence-limits",
      heading: "How to read Chinese Phase 3 numbers",
      body: [
    ...
    {
      id: "risks",
      heading: "Importation and 'research mazdutide' risks",
      body: [
