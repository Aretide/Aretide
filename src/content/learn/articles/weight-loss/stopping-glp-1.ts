...
export const article: LearnArticle = {
  ...
  slug: "stopping-glp-1",
  title: "Stopping a GLP-1 Medicine: Evidence After Discontinuation",
  h1: "Stopping a GLP-1: what studies show after the last dose",
  description:
  ...
  faqs: [
    ...
    {
      question: "Do I have to taper a weekly GLP-1?",
      answer:
    ...
    {
      question: "Is it dangerous to stop suddenly?",
      answer:
    ...
    {
      question: "How long does semaglutide stay in the body?",
      answer:
    ...
    {
      question: "Should I stop because of side effects?",
      answer:
  ...
  sections: [
    {
      id: "plan-not-panic",
      heading: "Stopping is a plan, not a panic",
      body: [
    ...
    {
      id: "what-trials-show",
      heading: "What the major discontinuation studies showed",
      body: [
    ...
    {
      id: "why-weight-returns",
      heading: "Why weight often returns",
      body: [
    ...
    {
      id: "diabetes-and-heart",
      heading: "Diabetes, heart, and surgical special cases",
      body: [
    ...
    {
      id: "how-to-stop",
      heading: "How clinicians commonly structure a stop",
      body: [
